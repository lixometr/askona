...
module.exports=g;/***/},/***/"./src/js/animations/section1.js":/*!***************************************!*\
  ...
  \***************************************//*! no static exports found *//***/function srcJsAnimationsSection1Js(module,exports){/**
 * autoAlfa: 0
 * visibilit: hidden;
 */gsap.to('.galaxy',{scrollTrigger:{trigger:".s1",pin:false,start:"top top",end:"+=400",scrub:true// fix can be in seconds (smooth delay)
// once: true
},y:-300});gsap.to('.s1__image',{scrollTrigger:{trigger:".s1",pin:false,start:"top top",end:"+=200",scrub:true// fix can be in seconds (smooth delay)
// once: true
},y:40});gsap.to('.s1__box',{scrollTrigger:{trigger:".s1",pin:false,start:"top top",end:"+=200",scrub:true// fix can be in seconds (smooth delay)
// once: true
},y:100});gsap.fromTo('.header__box, .s1__box',{opacity:0,y:-100},{y:0,opacity:1,autoAlpha:1,duration:.9});gsap.fromTo('.galaxy',{opacity:0,y:100},{y:0,opacity:1,autoAlpha:1,duration:.9});gsap.fromTo('.s1__image',{opacity:0,x:100},{x:0,opacity:1,autoAlpha:1,duration:.9});gsap.fromTo('#stars',{scale:1.4,opacity:0},{scale:1,autoAlpha:1,duration:1});gsap.to('#stars',{scrollTrigger:{trigger:".s5",pin:false,start:"top top",end:"+=400",scrub:false// fix can be in seconds (smooth delay)
// once: true
},opacity:0});// import throttle from "lodash.throttle"
...
// once: true
},y:'-=160'});gsap.to(image2,{scrollTrigger:{trigger:'.s3',pin:false,start:"top top",end:"+=1600",scrub:1.8// fix can be in seconds (smooth delay)
// once: true
},y:'-=100'});/***/},/***/"./src/js/animations/section4.js":/*!***************************************!*\
  !*** ./src/js/animations/section4.js ***!
  \***************************************//*! no static exports found *//***/function srcJsAnimationsSection4Js(module,exports){gsap.to('.s4__clouds',{scrollTrigger:{trigger:".s4__clouds",pin:false,start:"top bottom",end:"+=600",scrub:true// fix can be in seconds (smooth delay)
// once: true
...
// });
$(".s8-map__links > li:nth-child(2) a").click(function(e){e.preventDefault();var map=$(".s8-map__main");if(!map.hasClass("s8-map__main_list")){map.addClass("s8-map__main_list");}else{map.removeClass("s8-map__main_list");}});// $(".header__menu-btn").click(function(e){
// 	e.preventDefault();
...
// });
  ...
  !*** ./src/js/parallax.js ***!
  \****************************//*! no exports provided *//***/function srcJsParallaxJs(module,__webpack_exports__,__webpack_require__){"use strict";__webpack_require__.r(__webpack_exports__);/* harmony import */var lodash_throttle__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__(/*! lodash.throttle */"./node_modules/lodash.throttle/index.js");/* harmony import */var lodash_throttle__WEBPACK_IMPORTED_MODULE_0___default=/*#__PURE__*/__webpack_require__.n(lodash_throttle__WEBPACK_IMPORTED_MODULE_0__);function Parallax(options){var _this5=this;options=options||{};this.nameSpaces={wrapper:options.wrapper||'.parallax',layers:options.layers||'.parallax-layer',deep:options.deep||'data-parallax-deep'};this.onMouseMove=function(e,i){var self=_this5,parallaxWrappers=document.querySelectorAll(_this5.nameSpaces.wrapper);var layers=parallaxWrappers[i].querySelectorAll(self.nameSpaces.layers);for(var j=0;j<layers.length;j++){(function(j){var $this=$(layers[j]);var relX=e.pageX-$this.offset().left;var relY=e.pageY-$this.offset().top;var deep=layers[j].getAttribute(self.nameSpaces.deep),disallow=layers[j].getAttribute('data-parallax-disallow'),x=disallow&&disallow==='x'?0:(relX-$this.width()/2)/$this.width()*deep,y=disallow&&disallow==='y'?0:(relY-$this.height()/2)/$this.height()*deep;if(disallow&&disallow==='both')return;// layers[j].style.transform = 'translateX(' + x + 'px) translateY(' + y + 'px)';
gsap.to(layers[j],{x:x,y:y,duration:1});})(j);}};this.onMouseMove=lodash_throttle__WEBPACK_IMPORTED_MODULE_0___default()(this.onMouseMove.bind(this),200);this.init=function(){var self=this;var parallaxWrappers=document.querySelectorAll(this.nameSpaces.wrapper);for(var i=0;i<parallaxWrappers.length;i++){(function(i){parallaxWrappers[i].addEventListener('mousemove',function(e){self.onMouseMove(e,i);});})(i);}};this.init();return this;}window.addEventListener('load',function(){new Parallax();});/***/},/***/"./src/js/scripts.js":/*!***************************!*\
  !*** ./src/js/scripts.js ***!
  \***************************//*! no exports provided *//***/function srcJsScriptsJs(module,__webpack_exports__,__webpack_require__){"use strict";__webpack_require__.r(__webpack_exports__);/* WEBPACK VAR INJECTION */(function(global){/* harmony import */var gsap__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__(/*! gsap */"./node_modules/gsap/index.js");/* harmony import */var gsap_dist_ScrollTrigger_min_js__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__(/*! gsap/dist/ScrollTrigger.min.js */"./node_modules/gsap/dist/ScrollTrigger.min.js");/* harmony import */var gsap_dist_ScrollTrigger_min_js__WEBPACK_IMPORTED_MODULE_1___default=/*#__PURE__*/__webpack_require__.n(gsap_dist_ScrollTrigger_min_js__WEBPACK_IMPORTED_MODULE_1__);/* harmony import */var jquery__WEBPACK_IMPORTED_MODULE_2__=__webpack_require__(/*! jquery */"./node_modules/jquery/dist/jquery.js");/* harmony import */var jquery__WEBPACK_IMPORTED_MODULE_2___default=/*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_2__);/* harmony import */var _stars__WEBPACK_IMPORTED_MODULE_3__=__webpack_require__(/*! ./stars */"./src/js/stars.js");global.$=jquery__WEBPACK_IMPORTED_MODULE_2___default.a;gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].registerPlugin(gsap_dist_ScrollTrigger_min_js__WEBPACK_IMPORTED_MODULE_1___default.a);gsap_dist_ScrollTrigger_min_js__WEBPACK_IMPORTED_MODULE_1___default.a.defaults({markers:false});global.gsap=gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"];global.Stars=_stars__WEBPACK_IMPORTED_MODULE_3__["default"];// require('slick-carousel')
__webpack_require__(/*! ./my */"./src/js/my.js");__webpack_require__(/*! ./animations/section1 */"./src/js/animations/section1.js");__webpack_require__(/*! ./animations/section2 */"./src/js/animations/section2.js");__webpack_require__(/*! ./animations/section3 */"./src/js/animations/section3.js");__webpack_require__(/*! ./animations/section4 */"./src/js/animations/section4.js");__webpack_require__(/*! ./animations/section5 */"./src/js/animations/section5.js");__webpack_require__(/*! ./animations/section6 */"./src/js/animations/section6.js");__webpack_require__(/*! ./cursorFollow */"./src/js/cursorFollow.js");__webpack_require__(/*! ./slider1 */"./src/js/slider1.js");__webpack_require__(/*! ./slider2 */"./src/js/slider2.js");__webpack_require__(/*! ./parallax */"./src/js/parallax.js");var prevScroll=jquery__WEBPACK_IMPORTED_MODULE_2___default()(window).scrollTop();jquery__WEBPACK_IMPORTED_MODULE_2___default()(window).on('scroll',function(e){var nowScrollTop=jquery__WEBPACK_IMPORTED_MODULE_2___default()(window).scrollTop();if(nowScrollTop>prevScroll){_stars__WEBPACK_IMPORTED_MODULE_3__["default"].updateStarsY(-3);}else{_stars__WEBPACK_IMPORTED_MODULE_3__["default"].updateStarsY(3);}prevScroll=nowScrollTop;});/* WEBPACK VAR INJECTION */}).call(this,__webpack_require__(/*! ./../../node_modules/webpack/buildin/global.js */"./node_modules/webpack/buildin/global.js"));/***/},/***/"./src/js/slider1.js":/*!***************************!*\
  !*** ./src/js/slider1.js ***!
  \***************************//*! no static exports found *//***/function srcJsSlider1Js(module,exports){var Slider=function(){function Slider(){_classCallCheck(this,Slider);this.nowSlide=0;this.prevSlide=0;this.itemsWrapper=$('.s2__items');this.imagesWrapper=$('.s2__images');this.items=this.itemsWrapper.children();this.images=this.imagesWrapper.children();this.tabsWrapper=$('.s2__organs');this.tabs=this.tabsWrapper.children();this.arrowNext=$('.s2 .slider-arrow-next');this.arrowPrev=$('.s2 .slider-arrow-prev');this.isAnimating=false;this.init();}_createClass(Slider,[{key:'setSlide',value:function setSlide(idx){if(this.isAnimating)return;this.prevSlide=this.nowSlide;this.nowSlide=idx;this.animate();}},{key:'next',value:function next(){this.prevSlide=this.nowSlide;if(this.nowSlide>=this.items.length-1){this.nowSlide=0;}else{this.nowSlide++;}}},{key:'prev',value:function prev(){this.prevSlide=this.nowSlide;if(this.nowSlide<=0){this.nowSlide=this.items.length-1;}else{this.nowSlide--;}}},{key:'slideNext',value:function slideNext(){if(this.isAnimating)return;this.next();this.animate();}},{key:'slidePrev',value:function slidePrev(){if(this.isAnimating)return;this.prev();this.animate();}},{key:'animate',value:function animate(){var _this6=this;this.isAnimating=true;if(this.prevSlide<this.nowSlide){Stars.setSpeed(20);}else{Stars.setSpeed(-20);}var resolvers=[];resolvers.push(this.animateText());resolvers.push(this.animateImages());this.animateTabs();Promise.all(resolvers).then(function(){Stars.setSpeed(1);_this6.isAnimating=false;});}},{key:'animateText',value:function animateText(){var _this7=this;// const tl = gsap.timeline({
//     onComplete: () => {
//         Stars.setSpeed(1)
//     }
// })
...
//     display: 'block'
// })
return new Promise(function(resolve){_this7.items.eq(_this7.prevSlide).fadeOut(400,function(){_this7.items.eq(_this7.nowSlide).fadeIn(400,function(){return resolve();});});});}},{key:'animateImages',value:function animateImages(){var _this8=this;var tl=gsap.timeline();// tl.fromTo(this.images.eq(this.prevSlide)[0], {
//     opacity: 1,
// }, {
//     opacity: 0,
//     display: 'none'
...
//     position: 'relative'
// })
return new Promise(function(resolve){_this8.images.eq(_this8.prevSlide).fadeOut(400,function(){_this8.images.eq(_this8.nowSlide).fadeIn(400,function(){return resolve();});});});}},{key:'animateTabs',value:function animateTabs(){this.tabs.removeClass('s2-organ_active');var activeTab=this.tabs.eq(this.nowSlide);var prevTab=this.tabs.eq(this.prevSlide);activeTab.addClass('s2-organ_active');var prevLeft=prevTab.position().left;console.log(prevLeft);activeTab.css('left',0);}},{key:'addListeners',value:function addListeners(){var _this9=this;var self=this;this.tabs.on('click',function(){var idx=$(this).index();console.log(idx);self.setSlide(idx);});this.arrowNext.on('click',function(){_this9.slideNext();});this.arrowPrev.on('click',function(){_this9.slidePrev();});}},{key:'init',value:function init(){this.addListeners();}}]);return Slider;}();new Slider();/***/},/***/"./src/js/slider2.js":/*!***************************!*\
  !*** ./src/js/slider2.js ***!
  \***************************//*! no static exports found *//***/function srcJsSlider2Js(module,exports){var Slider=function(){function Slider(){_classCallCheck(this,Slider);this.nowSlide=0;this.prevSlide=0;this.itemsWrapper=$('.s4__items');this.imagesWrapper=$('.s4__images');this.items=this.itemsWrapper.children();this.images=this.imagesWrapper.children();this.arrowNext=$('.s4 .slider-arrow-next');this.arrowPrev=$('.s4 .slider-arrow-prev');this.isAnimating=false;this.init();}_createClass(Slider,[{key:'setSlide',value:function setSlide(idx){if(this.isAnimating)return;this.prevSlide=this.nowSlide;this.nowSlide=idx;this.animate();}},{key:'next',value:function next(){this.prevSlide=this.nowSlide;if(this.nowSlide>=this.items.length-1){this.nowSlide=0;}else{this.nowSlide++;}}},{key:'prev',value:function prev(){this.prevSlide=this.nowSlide;if(this.nowSlide<=0){this.nowSlide=this.items.length-1;}else{this.nowSlide--;}}},{key:'slideNext',value:function slideNext(){if(this.isAnimating)return;this.next();this.animate();}},{key:'slidePrev',value:function slidePrev(){if(this.isAnimating)return;this.prev();this.animate();}},{key:'animate',value:function animate(){var _this10=this;this.isAnimating=true;if(this.prevSlide<this.nowSlide){Stars.setSpeed(20);}else{Stars.setSpeed(-20);}var resolvers=[];resolvers.push(this.animateText());resolvers.push(this.animateImages());Promise.all(resolvers).then(function(){Stars.setSpeed(1);_this10.isAnimating=false;});}},{key:'animateText',value:function animateText(){var _this11=this;return new Promise(function(resolve){_this11.items.eq(_this11.prevSlide).fadeOut(400,function(){_this11.items.eq(_this11.nowSlide).fadeIn(400,function(){return resolve();});});});}},{key:'animateImages',value:function animateImages(){var _this12=this;var tl=gsap.timeline();return new Promise(function(resolve){_this12.images.eq(_this12.prevSlide).fadeOut(400,function(){_this12.images.eq(_this12.nowSlide).fadeIn(400,function(){return resolve();});});});}},{key:'addListeners',value:function addListeners(){var _this13=this;var self=this;this.arrowNext.on('click',function(){_this13.slideNext();});this.arrowPrev.on('click',function(){_this13.slidePrev();});}},{key:'init',value:function init(){this.addListeners();}}]);return Slider;}();new Slider();/***/},/***/"./src/js/stars.js":/*!*************************!*\
  !*** ./src/js/stars.js ***!
  \*************************//*! exports provided: default *//***/function srcJsStarsJs(module,__webpack_exports__,__webpack_require__){"use strict";__webpack_require__.r(__webpack_exports__);function random(min,max){return Math.random()*(max-min)+min;}var Star=function(){function Star(){var _ref3=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},color=_ref3.color,xPos=_ref3.xPos,yPos=_ref3.yPos;_classCallCheck(this,Star);this.defaults={color:'rgba(255, 255, 255, 1)',minRadius:0.5,maxRadius:1.4,minSpeed:.1,maxSpeed:.5,speed:1};this.minRadius=this.defaults.minRadius;this.maxRadius=this.defaults.maxRadius;this.minSpeed=this.defaults.minSpeed;this.maxSpeed=this.defaults.maxSpeed;this.speed=this.defaults.speed;this.radius=this.radius||random(this.minRadius,this.maxRadius);this.xPos=xPos;this.yPos=yPos;this.xVelocity=random(this.minSpeed,this.maxSpeed);this.yVelocity=random(this.minSpeed,this.maxSpeed);this.color=color||this.defaults.color;}_createClass(Star,[{key:'init',value:function init(){}},{key:'getVelocity',value:function getVelocity(){return{x:this.xVelocity*this.speed,y:this.yVelocity*this.speed};}},{key:'setSpeed',value:function setSpeed(speed){this.speed=speed;}}]);return Star;}();var Stars=function(){function Stars(){_classCallCheck(this,Stars);this.numStars=400;this.stars=[];this.canvas=document.getElementById('stars');this.ctx=this.canvas.getContext('2d');// this.ctx.filter = 'blur(300px) '
// this.canvas.style.filter = 'blur(10px)'
this.direction='horizontal';this.requestAnimationFrame=window.requestAnimationFrame;}_createClass(Stars,[{key:'setSpeed',value:function setSpeed(speed){this.stars.forEach(function(star){return star.setSpeed(speed);});}},{key:'setDirection',value:function setDirection(direction){this.direction=direction;}},{key:'speedUp',value:function speedUp(){}},{key:'updateStarsY',value:function updateStarsY(y){var _this14=this;this.stars.forEach(function(star){star.yPos+=y;if(star.yPos<0){star.yPos+=_this14.canvas.height+star.radius;star.xPos=random(0,_this14.canvas.width);}else if(star.yPos>_this14.canvas.height){star.yPos-=_this14.canvas.height+star.radius;star.xPos=random(0,_this14.canvas.width);}});}//Initalize
